...
export default function PortalSuportePage() {
  ...
  // 🚀 ADICIONADO isBackground para evitar que a tela de loading pisque ao atualizar pelo Realtime
  ...
  // 🚀 ATUALIZAÇÃO EM TEMPO REAL PARA O CLIENTE: Sem necessidade de dar Refresh (F5) para ver mudanças de status
  useEffect(() => {
